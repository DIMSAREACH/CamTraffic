    ...
    <div className="dashboard">
      ...
      {stats ? (
        <div className="dashboard-stats">
          ...
          <article className="dashboard-stats__item">
            ...
            <strong>{stats.detections_today}</strong>
          </article>
          <article className="dashboard-stats__item">
            <p>Reviewed by me</p>
            <strong>{stats.reviewed_by_me}</strong>
          </article>
        </div>
      ) : (
      ...
      {activities ? (
        <article className="dashboard-activities">
          <h4>Recent Station Activity</h4>
          {activities.items.length === 0 ? (
            <p className="auth-form__hint">No recent activity at your station.</p>
          ) : (
