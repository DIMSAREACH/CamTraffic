        ...
        <div className="enforcement-page__hero-inner">
          <div>
            <div className="enforcement-page__eyebrow">
              ...
              {isOfficer ? tr('officerSettings.eyebrow', 'Officer portal') : t('driverSettings.eyebrow')}
            </div>
            <h1 className="enforcement-page__title">
              {isOfficer ? tr('officerSettings.title', 'Officer settings') : t('driverSettings.title')}
            </h1>
            <p className="enforcement-page__subtitle">
              {isOfficer
                ? tr('officerSettings.subtitle', 'Language, appearance, and notification preferences')
                : t('driverSettings.subtitle')}
            </p>
          </div>
        </div>
      </div>
