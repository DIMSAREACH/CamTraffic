...
export function ReportsManagementPage({ onLoadCatalog, onLoadExports, onCreateExport }: ReportsManagementPageProps) {
  ...
  return (
    <Card title="Reports" subtitle="Tasks 052 & 054 — Report catalog, PDF/Excel/CSV export, and history">
        ...
        {exports.map((record) => (
          <article className="reports-list__item" key={record.id}>
            ...
            <p className="auth-form__hint">
              Requested by {record.requested_by_email} · {new Date(record.created_at).toLocaleString()}
            </p>
