...
const FAQ_ITEMS = [
  ...
  { qKey: 'support.faqQ4', aKey: 'support.faq4' },
] as const;
...
export function CitizenSupportPage() {
  ...
  const resourceLinks = [
    ...
    },
    {
      tone: 'violet',
      icon: BookOpen,
      titleKey: 'support.signsLink',
      descKey: 'support.signsLinkDesc',
      onClick: () => navigate(CITIZEN_PORTAL_ROUTES.signs),
    },
    {
      tone: 'emerald',
      icon: HelpCircle,
      titleKey: 'support.rulesLink',
      descKey: 'support.rulesLinkDesc',
      onClick: () => navigate(CITIZEN_PORTAL_ROUTES.trafficRules),
    },
  ];
        ...
        <div className="enforcement-page__hero-inner support-page__hero-inner">
          <div>
            ...
            <div className="enforcement-page__eyebrow">
              ...
              {t('support.eyebrow')} · {t('support.helpDeskGuide')}
            </div>
