...
import {
  ...
  FileText, Shield, Trash2, ImageIcon, MapPin, Plus, DollarSign, Pencil, Loader2,
} from 'lucide-react';
                    ...
                    <div className="violations-view-dialog__header-copy">
                      <div className="violations-view-dialog__title-row">
                        <h2 className="violations-view-dialog__header-title">
                          {formatViolationType(selected.violation_type)}
                        </h2>
                        <span className="violations-view-dialog__id-chip" title={String(selected.id)}>
                          #{shortId}
                        </span>
                        <span
