    ...
    with _WARM_LOCK:
        ...
        try:
            ...
            if sign_model is not None:
                sign_model.predict(blank, imgsz=imgsz, verbose=False)
            if vehicle_model is not None:
                vehicle_model.predict(blank, imgsz=imgsz, verbose=False)
            if plate_model is not None:
                plate_model.predict(blank, imgsz=imgsz, verbose=False)
