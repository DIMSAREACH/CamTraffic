...
Implement **Flutter Mobile Setup** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task008 — Flutter Mobile Setup
Phase: Phase 1 — Project Foundation

Read docs/tasks/Task008.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task008 and list files changed.
```
