...
Implement **Dark Mode** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task125 — Dark Mode
Phase: Phase 11 — Enterprise UI/UX

Read docs/tasks/Task125.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task125 and list files changed.
```
