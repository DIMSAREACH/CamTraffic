...
Implement **Camera Integration** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task108 — Camera Integration
Phase: Phase 9 — Mobile App

Read docs/tasks/Task108.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task108 and list files changed.
```
