# Task017 — AI Model & Dataset Tables
...
Implement **AI Model & Dataset Tables** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task017 — AI Model & Dataset Tables
Phase: Phase 2 — Database Design

Read docs/tasks/Task017.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task017 and list files changed.
```
