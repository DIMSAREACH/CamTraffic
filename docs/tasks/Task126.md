...
Implement **Light Mode** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task126 — Light Mode
Phase: Phase 11 — Enterprise UI/UX

Read docs/tasks/Task126.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task126 and list files changed.
```
