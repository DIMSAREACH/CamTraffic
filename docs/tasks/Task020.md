...
Implement **Seed Data & Migrations** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task020 — Seed Data & Migrations
Phase: Phase 2 — Database Design

Read docs/tasks/Task020.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task020 and list files changed.
```
