...
Implement **Docker Production** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task141 — Docker Production
Phase: Phase 13 — Deployment

Read docs/tasks/Task141.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task141 and list files changed.
```
