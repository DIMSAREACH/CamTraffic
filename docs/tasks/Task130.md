...
Implement **Accessibility** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task130 — Accessibility
Phase: Phase 11 — Enterprise UI/UX

Read docs/tasks/Task130.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task130 and list files changed.
```
