...
Implement **Profile** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task029 — Profile
Phase: Phase 3 — Authentication

Read docs/tasks/Task029.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task029 and list files changed.
```
