...
Implement **AI Settings** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task070 — AI Settings
Phase: Phase 5 — AI Module

Read docs/tasks/Task070.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task070 and list files changed.
```
