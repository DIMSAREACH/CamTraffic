...
Implement **Dataset Upload** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task057 — Dataset Upload
Phase: Phase 5 — AI Module

Read docs/tasks/Task057.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task057 and list files changed.
```
