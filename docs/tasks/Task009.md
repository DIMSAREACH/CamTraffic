...
Implement **CI/CD & Git Workflow** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task009 — CI/CD & Git Workflow
Phase: Phase 1 — Project Foundation

Read docs/tasks/Task009.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task009 and list files changed.
```
