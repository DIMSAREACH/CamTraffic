# Task004 — Backend (Django + DRF) Setup
...
Implement **Backend (Django + DRF) Setup** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task004 — Backend (Django + DRF) Setup
Phase: Phase 1 — Project Foundation

Read docs/tasks/Task004.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task004 and list files changed.
```
