...
Implement **Officer Mobile** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task103 — Officer Mobile
Phase: Phase 9 — Mobile App

Read docs/tasks/Task103.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task103 and list files changed.
```
