...
Implement **Reset Password** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task025 — Reset Password
Phase: Phase 3 — Authentication

Read docs/tasks/Task025.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task025 and list files changed.
```
