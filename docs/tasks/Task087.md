...
Implement **Reports** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task087 — Reports
Phase: Phase 7 — Officer Portal

Read docs/tasks/Task087.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task087 and list files changed.
```
