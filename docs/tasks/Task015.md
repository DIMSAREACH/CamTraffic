...
Implement **Traffic Sign Tables** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task015 — Traffic Sign Tables
Phase: Phase 2 — Database Design

Read docs/tasks/Task015.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task015 and list files changed.
```
