# Task002 — Monorepo Folder Structure
...
Implement **Monorepo Folder Structure** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task002 — Monorepo Folder Structure
Phase: Phase 1 — Project Foundation

Read docs/tasks/Task002.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task002 and list files changed.
```
