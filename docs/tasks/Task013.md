...
Implement **Officer & Driver Tables** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task013 — Officer & Driver Tables
Phase: Phase 2 — Database Design

Read docs/tasks/Task013.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task013 and list files changed.
```
