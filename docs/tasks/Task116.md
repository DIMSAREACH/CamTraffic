...
Implement **Export CSV** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task116 — Export CSV
Phase: Phase 10 — Reports & Analytics

Read docs/tasks/Task116.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task116 and list files changed.
```
