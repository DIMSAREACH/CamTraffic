...
Implement **Heat Maps** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task117 — Heat Maps
Phase: Phase 10 — Reports & Analytics

Read docs/tasks/Task117.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task117 and list files changed.
```
