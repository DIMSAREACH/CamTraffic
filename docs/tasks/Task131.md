...
Implement **Backend Unit Tests** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task131 — Backend Unit Tests
Phase: Phase 12 — Testing

Read docs/tasks/Task131.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task131 and list files changed.
```
