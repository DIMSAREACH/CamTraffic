...
Implement **AI Training Center** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task060 — AI Training Center
Phase: Phase 5 — AI Module

Read docs/tasks/Task060.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task060 and list files changed.
```
