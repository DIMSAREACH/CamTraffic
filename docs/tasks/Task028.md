...
Implement **Session Management** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task028 — Session Management
Phase: Phase 3 — Authentication

Read docs/tasks/Task028.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task028 and list files changed.
```
