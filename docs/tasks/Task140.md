...
Implement **Bug Fixing** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task140 — Bug Fixing
Phase: Phase 12 — Testing

Read docs/tasks/Task140.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task140 and list files changed.
```
