# Task018 — Violation, Evidence & Fine Tables
...
Implement **Violation, Evidence & Fine Tables** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task018 — Violation, Evidence & Fine Tables
Phase: Phase 2 — Database Design

Read docs/tasks/Task018.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task018 and list files changed.
```
