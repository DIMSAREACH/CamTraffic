...
Implement **OCR Model Training** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task064 — OCR Model Training
Phase: Phase 5 — AI Module

Read docs/tasks/Task064.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task064 and list files changed.
```
