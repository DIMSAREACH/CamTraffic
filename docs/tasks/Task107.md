...
Implement **Offline Support** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task107 — Offline Support
Phase: Phase 9 — Mobile App

Read docs/tasks/Task107.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task107 and list files changed.
```
