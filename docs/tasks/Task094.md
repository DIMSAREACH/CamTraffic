...
Implement **My Violations** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task094 — My Violations
Phase: Phase 8 — Driver Portal

Read docs/tasks/Task094.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task094 and list files changed.
```
