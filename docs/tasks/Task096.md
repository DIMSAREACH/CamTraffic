...
Implement **Fine Payment** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task096 — Fine Payment
Phase: Phase 8 — Driver Portal

Read docs/tasks/Task096.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task096 and list files changed.
```
