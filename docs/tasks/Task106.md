...
Task: Task106 — Notifications
Phase: Phase 9 — Mobile App

Read docs/tasks/Task106.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task106 and list files changed.
```
