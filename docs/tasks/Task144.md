...
Implement **CI/CD Pipeline** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task144 — CI/CD Pipeline
Phase: Phase 13 — Deployment

Read docs/tasks/Task144.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task144 and list files changed.
```
