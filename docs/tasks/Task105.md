...
Implement **AI Detection Viewer** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task105 — AI Detection Viewer
Phase: Phase 9 — Mobile App

Read docs/tasks/Task105.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task105 and list files changed.
```
