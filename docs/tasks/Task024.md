...
Implement **Forgot Password** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task024 — Forgot Password
Phase: Phase 3 — Authentication

Read docs/tasks/Task024.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task024 and list files changed.
```
