...
Implement **Logout** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Read docs/tasks/Task023.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task023 and list files changed.
```
