...
Implement **Design System** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task121 — Design System
Phase: Phase 11 — Enterprise UI/UX

Read docs/tasks/Task121.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task121 and list files changed.
```
