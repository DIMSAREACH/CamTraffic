...
Implement **Build Release** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task110 — Build Release
Phase: Phase 9 — Mobile App

Read docs/tasks/Task110.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task110 and list files changed.
```
