...
Implement **Evidence Viewer** for CamTraffic (AI-based traffic sign detection and traffic law enforcement in Cambodia).
...
Task: Task095 — Evidence Viewer
Phase: Phase 8 — Driver Portal

Read docs/tasks/Task095.md and docs/CHECKLIST.md.
Implement only this task. Match existing conventions in backend/, frontend-admin/, frontend-user/, ai/.
When done, update docs/CHECKLIST.md checkbox for Task095 and list files changed.
```
