            <CardWrap className="overflow-hidden flex flex-col min-h-[420px] h-full flex-1">
              <div className="relative px-5 pt-5 pb-10 flex-shrink-0"
                ...
                <div className="relative flex items-center justify-between gap-3">
                  <div className="min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <p className="text-[14px] font-bold text-white leading-tight">{t('aiDetection.uploadTitle')}</p>
                    </div>
                    <p className="text-[11px] text-white/65 pl-10">{t('aiDetection.uploadSubtitle')}</p>
                  </div>
